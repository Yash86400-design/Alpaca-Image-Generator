...
const allAccessories = { 'default': headphone, 'earings': earings, 'flower': flower, 'glasses': glasses };

const allBackgrounds = { 'default': darkblue50, 'blue50': blue50, 'blue60': blue60, 'blue70': blue70, 'darkblue30': darkblue30, 'darkblue70': darkblue70, 'green50': green50, 'green60': green60, 'green70': green70, 'grey40': grey40, 'grey70': grey70, 'grey80': grey80, 'red50': red50, 'red60': red60, 'red70': red70, 'yellow50': yellow50, 'yellow60': yellow60, 'yellow70': yellow70 };

const allEars = { 'default': defaultEar, 'tilt-backward': tiltBackwardEar, 'tilt-forward': tiltForwardEar };

const allEyes = { 'default': defaultEye, 'angry': angry, 'naughty': naughty, 'panda': panda, 'smart': smart, 'star': star };

const allHair = { 'default': defaultHair, 'bang': bang, 'curls': curls, 'elegant': elegant, 'fancy': fancy, 'quiff': quiff, 'short': short };

const allLeg = { 'default': defaultLeg, 'bubbleTea': bubbleTea, 'cookie': cookie, 'gameConsole': gameConsole, 'tilt-backward': tiltBackwardLeg, 'tilt-forward': tiltForwardLeg };

const allMouth = { 'default': defaultMouth, 'astonished': astonished, 'eating': eating, 'laugh': laugh, 'tongue': tongue };

const allNeck = { 'default': defaultNeck, 'bend-backward': bendBackwardNeck, 'bend-forward': bendForwardNeck, 'thick': thick };
...
export {
  allAccessories, allBackgrounds, allEars, allEyes, allHair, allLeg, allMouth, allNeck, nose
};
